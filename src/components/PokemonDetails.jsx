...
export const PokemonDetails = (...props) => {
  let pokeId = props[0].match.params.id;
  let data = props[0].data;
  console.log("pokeId", pokeId);

  let pokemon = data.filter((element) => element[0].id == pokeId);
  let poke = pokemon[0][0];

  // console.log("это он ", pokemonInfo);
  // console.log(props[0]);

  const pokemonImg = poke.sprites.other.dream_world.front_default;
